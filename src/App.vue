                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-3" style="text-align:right">
                            <button class="btn btn-secondary" v-on:click="close_modal" aria-label="Close alert"
                                    type="button" data-close style="text-align: center">
...
<script>
    ...
    import {
        field, //data fields from data/index.js
        pull, //pulls all fields in field from api
        push, //pushes all fields to the api
        pull_state, //returns the stored index, tab, and advanced status from business_settings['setup_wizard']
        push_state //stores the current index, tab, and advanced status to business_settings['setup_wizard']
    } from './data/index'
